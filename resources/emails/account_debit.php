...
<div style="text-align: center; margin-bottom: 24px;">
    <h2 style="margin: 0; color: #0d121c; font-size: 24px;">Account Debited</h2>
</div>
...
<p style="color: #4b5563; font-size: 16px; line-height: 1.5; margin-bottom: 24px;">
    We are writing to inform you that your NovaTrust account has been debited by <strong><?= htmlspecialchars($amountFormatted) ?></strong>.
</p>
