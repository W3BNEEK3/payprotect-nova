...
$router->post('/api/chat/auth', 'Api\ChatApiController@pusherAuth', [\App\Middlewares\AuthMiddleware::class]);
$router->post('/api/chat/admin/auth', 'Api\ChatApiController@pusherAuthAdmin', [\App\Middlewares\AdminMiddleware::class]);
